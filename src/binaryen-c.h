...
#if !defined(BINARYEN_CONST) && defined(__GNUC__)
#define BINARYEN_CONST __attribute((const))
#elif !defined(BINARYEN_CONST) && defined(__has_c_attribute)
#if __has_c_attribute(unsequenced)
#define BINARYEN_CONST [[unsequenced]]
#endif
#endif

#ifndef BINARYEN_CONST
#define BINARYEN_CONST
#endif

#define BINARYEN_API_CONST BINARYEN_API BINARYEN_CONST
...
BINARYEN_API_CONST BinaryenType BinaryenTypeNone(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeInt32(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeInt64(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeFloat32(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeFloat64(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeVec128(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeFuncref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeExternref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeAnyref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeEqref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeI31ref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeStructref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeArrayref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeStringref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeNullref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeNullExternref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeNullFuncref(void);
BINARYEN_API_CONST BinaryenType BinaryenTypeUnreachable(void);
// Not a real type. Used as the last parameter to BinaryenBlock to let
// the API figure out the type instead of providing one.
BINARYEN_API_CONST BinaryenType BinaryenTypeAuto(void);
...
WASM_DEPRECATED BINARYEN_CONST BinaryenType BinaryenNone(void);
WASM_DEPRECATED BINARYEN_CONST BinaryenType BinaryenInt32(void);
WASM_DEPRECATED BINARYEN_CONST BinaryenType BinaryenInt64(void);
WASM_DEPRECATED BINARYEN_CONST BinaryenType BinaryenFloat32(void);
WASM_DEPRECATED BINARYEN_CONST BinaryenType BinaryenFloat64(void);
WASM_DEPRECATED BINARYEN_CONST BinaryenType BinaryenUndefined(void);

// Packed types (call to get the value of each; you can cache them)

typedef uint32_t BinaryenPackedType;

BINARYEN_API_CONST BinaryenPackedType BinaryenPackedTypeNotPacked(void);
BINARYEN_API_CONST BinaryenPackedType BinaryenPackedTypeInt8(void);
BINARYEN_API_CONST BinaryenPackedType BinaryenPackedTypeInt16(void);

// Heap types

typedef uintptr_t BinaryenHeapType;

BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeExt(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeFunc(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeAny(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeEq(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeI31(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeStruct(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeArray(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeString(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeNone(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeNoext(void);
BINARYEN_API_CONST BinaryenHeapType BinaryenHeapTypeNofunc(void);
...
BINARYEN_API_CONST BinaryenExpressionId BinaryenInvalidId(void);

#define DELEGATE(CLASS_TO_VISIT)                                               \
  BINARYEN_API_CONST BinaryenExpressionId Binaryen##CLASS_TO_VISIT##Id(void);
...
BINARYEN_API_CONST BinaryenExternalKind BinaryenExternalFunction(void);
BINARYEN_API_CONST BinaryenExternalKind BinaryenExternalTable(void);
BINARYEN_API_CONST BinaryenExternalKind BinaryenExternalMemory(void);
BINARYEN_API_CONST BinaryenExternalKind BinaryenExternalGlobal(void);
BINARYEN_API_CONST BinaryenExternalKind BinaryenExternalTag(void);
...
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureMVP(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureAtomics(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureMutableGlobals(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureNontrappingFPToInt(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureSIMD128(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureBulkMemory(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureSignExt(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureExceptionHandling(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureTailCall(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureReferenceTypes(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureMultivalue(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureGC(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureMemory64(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureRelaxedSIMD(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureExtendedConst(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureStrings(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureMultiMemory(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureStackSwitching(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureSharedEverything(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureFP16(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureBulkMemoryOpt(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureCallIndirectOverlong(void);
BINARYEN_API_CONST BinaryenFeatures BinaryenFeatureAll(void);
...
BINARYEN_API_CONST BinaryenOp BinaryenClzInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenCtzInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenPopcntInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenCeilFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenFloorFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenNearestFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenSqrtFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqZInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenClzInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenCtzInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenPopcntInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenCeilFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenFloorFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenNearestFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenSqrtFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqZInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenWrapInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSFloat32ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSFloat32ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncUFloat32ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncUFloat32ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSFloat64ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSFloat64ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncUFloat64ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncUFloat64ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenReinterpretFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenReinterpretFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertSInt32ToFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertSInt32ToFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertUInt32ToFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertUInt32ToFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertSInt64ToFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertSInt64ToFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertUInt64ToFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertUInt64ToFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenPromoteFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenDemoteFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenReinterpretInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenReinterpretInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendS8Int32(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendS16Int32(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendS8Int64(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendS16Int64(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendS32Int64(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenRemSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenRemUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenAndInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenOrInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenXorInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenShlInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenRotLInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenRotRInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeSInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeUInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivSInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivUInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenRemSInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenRemUInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenAndInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenOrInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenXorInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenShlInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrUInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrSInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenRotLInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenRotRInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtSInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtUInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeSInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeUInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtSInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtUInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeSInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeUInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenCopySignFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeFloat32(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenCopySignFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeFloat64(void);
BINARYEN_API_CONST BinaryenOp BinaryenAtomicRMWAdd(void);
BINARYEN_API_CONST BinaryenOp BinaryenAtomicRMWSub(void);
BINARYEN_API_CONST BinaryenOp BinaryenAtomicRMWAnd(void);
BINARYEN_API_CONST BinaryenOp BinaryenAtomicRMWOr(void);
BINARYEN_API_CONST BinaryenOp BinaryenAtomicRMWXor(void);
BINARYEN_API_CONST BinaryenOp BinaryenAtomicRMWXchg(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatSFloat32ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatSFloat32ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatUFloat32ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatUFloat32ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatSFloat64ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatSFloat64ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatUFloat64ToInt32(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatUFloat64ToInt64(void);
BINARYEN_API_CONST BinaryenOp BinaryenSplatVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenReplaceLaneVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenSplatVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenReplaceLaneVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenSplatVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenReplaceLaneVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenSplatVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenReplaceLaneVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenSplatVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenReplaceLaneVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenSplatVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtractLaneVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenReplaceLaneVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtSVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtSVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeSVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeSVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenEqVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenNeVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenLtVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenGtVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenLeVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenGeVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenNotVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenAndVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenOrVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenXorVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenAndNotVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenBitselectVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedMaddVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedNmaddVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedMaddVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedNmaddVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenLaneselectI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenLaneselectI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenLaneselectI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLaneselectI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenDotI8x16I7x16AddSToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenAnyTrueVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenPopcntVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenAllTrueVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenBitmaskVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenShlVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddSatSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddSatUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubSatSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubSatUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxSVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenAvgrUVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenAllTrueVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenBitmaskVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenShlVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddSatSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddSatUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubSatSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubSatUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenAvgrUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenQ15MulrSatSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulLowSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulHighSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulLowUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulHighUVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenAllTrueVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenBitmaskVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenShlVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenDotSVecI16x8ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulLowSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulHighSVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulLowUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulHighUVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenAllTrueVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenBitmaskVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenShlVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrSVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenShrUVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulLowSVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulHighSVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulLowUVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtMulHighUVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenSqrtVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenPMinVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenPMaxVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenCeilVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenFloorVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenNearestVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenAbsVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenNegVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenSqrtVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenAddVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenSubVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenMulVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenDivVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenMinVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenMaxVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenPMinVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenPMaxVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenCeilVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenFloorVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenNearestVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtAddPairwiseSVecI8x16ToI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtAddPairwiseUVecI8x16ToI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtAddPairwiseSVecI16x8ToI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtAddPairwiseUVecI16x8ToI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatSVecF32x4ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatUVecF32x4ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertSVecI32x4ToVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertUVecI32x4ToVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad8SplatVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad16SplatVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad32SplatVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad64SplatVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad8x8SVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad8x8UVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad16x4SVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad16x4UVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad32x2SVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad32x2UVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad32ZeroVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad64ZeroVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad8LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad16LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad32LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenLoad64LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenStore8LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenStore16LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenStore32LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenStore64LaneVec128(void);
BINARYEN_API_CONST BinaryenOp BinaryenNarrowSVecI16x8ToVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenNarrowUVecI16x8ToVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenNarrowSVecI32x4ToVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenNarrowUVecI32x4ToVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendLowSVecI8x16ToVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendHighSVecI8x16ToVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendLowUVecI8x16ToVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendHighUVecI8x16ToVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendLowSVecI16x8ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendHighSVecI16x8ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendLowUVecI16x8ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendHighUVecI16x8ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendLowSVecI32x4ToVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendHighSVecI32x4ToVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendLowUVecI32x4ToVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenExtendHighUVecI32x4ToVecI64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertLowSVecI32x4ToVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenConvertLowUVecI32x4ToVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatZeroSVecF64x2ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenTruncSatZeroUVecF64x2ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenDemoteZeroVecF64x2ToVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenPromoteLowVecF32x4ToVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedTruncSVecF32x4ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedTruncUVecF32x4ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedTruncZeroSVecF64x2ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedTruncZeroUVecF64x2ToVecI32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenSwizzleVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedSwizzleVecI8x16(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedMinVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedMaxVecF32x4(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedMinVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedMaxVecF64x2(void);
BINARYEN_API_CONST BinaryenOp BinaryenRelaxedQ15MulrSVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenDotI8x16I7x16SToVecI16x8(void);
BINARYEN_API_CONST BinaryenOp BinaryenRefAsNonNull(void);
BINARYEN_API_CONST BinaryenOp BinaryenRefAsExternInternalize(void);
BINARYEN_API_CONST BinaryenOp BinaryenRefAsExternExternalize(void);
BINARYEN_API_CONST BinaryenOp BinaryenRefAsAnyConvertExtern(void);
BINARYEN_API_CONST BinaryenOp BinaryenRefAsExternConvertAny(void);
BINARYEN_API_CONST BinaryenOp BinaryenBrOnNull(void);
BINARYEN_API_CONST BinaryenOp BinaryenBrOnNonNull(void);
BINARYEN_API_CONST BinaryenOp BinaryenBrOnCast(void);
BINARYEN_API_CONST BinaryenOp BinaryenBrOnCastFail(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringNewLossyUTF8Array(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringNewWTF16Array(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringNewFromCodePoint(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringMeasureUTF8(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringMeasureWTF16(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringEncodeLossyUTF8Array(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringEncodeWTF16Array(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringEqEqual(void);
BINARYEN_API_CONST BinaryenOp BinaryenStringEqCompare(void);
